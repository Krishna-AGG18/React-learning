...
function Signup() {
    ...
    return (
        <div className='flex items-center justify-center w-full py-8 bg-[url(https://i.pinimg.com/originals/c6/4a/d7/c64ad796870df5a6c33be02a557677c9.gif)] bg-cover bg-center min-h-screen'>
            <div className="mx-auto w-full max-w-lg bg-black/60 backdrop-blur-md max-xs:px-6 max-sm:w-10/12 rounded-xl p-10 border border-gray-700 shadow-lg">
                ...
                {error && <p className="text-red-500 mt-8 text-center">{String(error)}</p>}
